...
print(
    f"Средняя оценка за дз у Никитина больше, чем у Кузнецова {second_student < first_student}")
print(
    f"Средняя оценка за лекции у Филипова меньше, чем у Орлова {second_lecturer < first_lecturer}\n")

# Подсчет средней оценки за курсы по дз и за леции:
print(
    f'Средняя оценка студентов за курс GIT: {average_rating_hw(student_list, "GIT")}')
print(
    f'Средняя оценка студентов за курс Python: {average_rating_hw(student_list, "Python")}')
print(
    f'Средняя оценка лекторов за курс Python: {average_rating_lesson(lecturer_list, "Python")}')
print(
    f'Средняя оценка лекторов за курс GIT: {average_rating_lesson(lecturer_list, "GIT")}')